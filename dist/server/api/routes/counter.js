...
exports.router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                counter = new Counter_js_1.counterModel(req.body);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, counter.save()];
            case 2:
                _a.sent();
                res.send(counter);
                return [3, 4];
...
exports.router.patch('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, Counter_js_1.counterModel.findByIdAndUpdate(req.params.id, req.body)];
            case 1:
                counter = _a.sent();
                res.status(200);
                return [3, 3];
...
exports.router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, Counter_js_1.counterModel.findByIdAndDelete(req.params.id)];
            case 1:
                counter = _a.sent();
                if (!counter)
