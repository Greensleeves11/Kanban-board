...
exports.router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, List_js_1.listModel.find({})];
            case 1:
                lists = _a.sent();
                try {
                    res.send(lists);
...
exports.router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                list = new List_js_1.listModel(req.body);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, list.save()];
...
exports.router.patch('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, List_js_1.listModel.findByIdAndUpdate(req.params.id, req.body)];
            case 1:
                _a.sent();
                res.status(200);
                return [3, 3];
...
exports.router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, List_js_1.listModel.findByIdAndDelete(req.params.id)];
            case 1:
                list = _a.sent();
                if (!list)
