...
exports.router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, Task_js_1.taskModel.find({})];
            case 1:
                tasks = _a.sent();
                try {
                    res.send(tasks);
...
exports.router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                task = new Task_js_1.taskModel(req.body);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, task.save()];
...
exports.router.patch('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, Task_js_1.taskModel.findByIdAndUpdate(req.params.id, req.body)];
            case 1:
                _a.sent();
                res.status(200).send();
                return [3, 3];
...
exports.router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, Task_js_1.taskModel.findByIdAndDelete(req.params.id)];
            case 1:
                task = _a.sent();
                if (!task)
