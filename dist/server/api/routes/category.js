...
exports.router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, Category_js_1.categoryModel.find({})];
            case 1:
                categories = _a.sent();
                try {
                    res.send(categories);
...
exports.router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                category = new Category_js_1.categoryModel(req.body);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, category.save()];
            case 2:
                _a.sent();
                res.send(category);
                return [3, 4];
...
exports.router.patch('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, Category_js_1.categoryModel.findByIdAndUpdate(req.params.id, req.body)];
            case 1:
                _a.sent();
                res.status(200).send();
                return [3, 3];
...
exports.router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, Category_js_1.categoryModel.findByIdAndDelete(req.params.id)];
            case 1:
                category = _a.sent();
                if (!category)
